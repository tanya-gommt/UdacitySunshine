...
public class TaskContentProvider extends ContentProvider {
    ...
    public static final int DIR_TASK =100;
    public static final int TASK_ID=101;

    // TODO (3) Declare a static variable for the Uri matcher that you construct
    public static final UriMatcher sUriMatcher = buildUiMatcher();
    // TODO (2) Define a static buildUriMatcher method that associates URI's with their int match
    public static UriMatcher buildUiMatcher(){
        UriMatcher mUriMatcher;

        mUriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
        mUriMatcher.addURI(TaskContract.AUTHORITY,TaskContract.PATH_TASKS,DIR_TASK);
        mUriMatcher.addURI(TaskContract.AUTHORITY,TaskContract.PATH_TASKS + "/#" ,TASK_ID);
        return mUriMatcher;
    }
