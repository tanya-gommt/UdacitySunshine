...
public class ReminderUtilities {
    ...
    synchronized public static void scheduleChargingReminder(@NonNull final Context context) throws XmlPullParserException {
        if (sInitialized) return;
        Driver driver = new Driver((XmlPullParser) context);
        FirebaseJobDispatcher dispatcher = new FirebaseJobDispatcher((com.firebase.jobdispatcher.Driver) driver);
